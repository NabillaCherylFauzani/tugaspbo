...
public class PembayaranSwalayan {
    ...
    public static void main(String[] args) {
       int nX, nY, nZ;
        ...
        System.out.println("diskon merk x: Rp. " + diskonX);
        System.out.println("diskon merk y: Rp. " + diskonY);
        System.out.println("diskon merk z: Rp. " + diskonZ);
